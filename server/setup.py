...
try:
	os.system("cd /home/pkoelin/create_ap && sudo make install")
except:
	pass
...
try:
	os.system('sudo touch /home/pkoelin/startup.sh')
	with open("/home/pkoelin/startup.sh",'w') as file_to_write:
...
os.system('sudo chmod 777 /home/pkoelin/startup.sh')

replace_num('/etc/rc.local','fi','fi\n/home/pkoelin/startup.sh start')

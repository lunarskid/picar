...
path_get = str(search('/home/pkoelin/','server.py'))
...
if command_select == '1':
	try:
		try:
			os.system('sudo rm -rf /home/pkoelin/.config/autostart')
		except:
			pass
		os.system('sudo mkdir /home/pkoelin/.config/autostart')
		os.system('sudo touch /home/pkoelin/.config/autostart/car.desktop')
		with open("/home/pkoelin/.config/autostart/car.desktop",'w') as file_to_write:
